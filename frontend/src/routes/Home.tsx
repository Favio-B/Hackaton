            ...
            <div className="card h-100 card-hover">
              <div className="card-body text-center">
                ...
                <p className="card-text">
                  ...
                  Nuestros modelos pueden identificar correlaciones complejas y hacer proyecciones precisas 
            ...
            <div className="card h-100 card-hover">
              <div className="card-body text-center">
                ...
                <p className="card-text">
                  ...
                  Transforma datos complejos en visualizaciones claras y comprensibles que facilitan 
            ...
            <div className="card h-100 card-hover">
              <div className="card-body text-center">
                ...
                <p className="card-text">
                  ...
                  Configura pipelines de datos que se ejecutan automáticamente, ahorrando tiempo 
                  y reduciendo errores humanos en el procesamiento de información.
                </p>
              </div>
            </div>
          </div>
